...
Thank you, Lisa. Good afternoon, everyone. Welcome to NXP Semiconductors First Quarter Earnings Call. With me on the call today is Rafael Sotomayor, NXP's President and CEO; and Bill Betz, our CFO. The call today is being recorded and will be available for replay from our corporate website.

Today's call will include forward-looking statements that involve risks and uncertainties that could cause NXP's results to differ materially from management's current expectations. These risks and uncertainties include, but are not limited to, statements regarding the macroeconomic impact on the specific end markets in which we operate, the sale of new and existing products and our expectations for the financial results for the second quarter of 2026. NXP undertakes no obligation to revise or update publicly any forward-looking statements. For a full disclosure of forward-looking statements, please refer to our press release.
...
With communications infrastructure, revenue was $380 million, up 21% year-on-year and at the high end of our guidance. Growth was driven by digital networking exposure to data center and continued ramps of our UCODE RFID product. And lastly, mobile revenue was $391 million, up 16% year-over-year and in line with guidance, reflecting continued strength in our secure mobile transactions franchise.
...
[Operator Instructions] First question will be coming from the line of Vivek Arya of Bank of America Securities.
...
Given the commentary you've made and the idiosyncratic growth drivers you're seeing relative to '26 and '27, just wanted to clarify that you are still on track to sort of deliver to your Analyst Day targets from 2024 out into 2027. And maybe you can confirm both the revenue and gross margin side of that.
...
Yes. And just to add the secular drivers, they continue to perform very, very well. We expect for the auto ones to be above our high end into Q2 and also for industrial & IoT, the growth rates to be above the high end of what we said for our industrial & IoT growth drivers that are company specific.
...
Yes. I'll give you an update. This is Rafael. So I think let's start with TTTech. I think great engineering organization. They have been redeployed now to our internal efforts to do S32 CoreRide. This is a very important kind of initiative that we have. We expect to sample with customers in Q3, the zonal reference design, the zonal K5 reference design that involves not only the K5, but other MCUs and our 48-volt architecture, and we're doing it both in the East and the West. I think we have high single-digit number of customers engaged in POCs. So it's quite exciting. And we do expect that this effort is going to accelerate the K5 adoption into 2027.

Aviva Links, I think, is a great platform that we got on SerDes platform. This is an open standard, very important for SDVs given the fact that the sensors and displays are multiplying in next-generation vehicles and all these are connected to SerDes. And I think companies are looking for an open platform versus the proprietary solutions they have today. We have customer awards now, and we expect to be in production with them in 2028. So this is a new SAM for us. This is a new market that we haven't entered. And in the past, there were 2 very entrenched, obviously, competitors there. But now with this open standard allows NXP to come and compete and compete with great technology.
